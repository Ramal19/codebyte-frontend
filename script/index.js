...
const postsDiv = document.getElementById("posts");
const btnDirection = document.querySelector(".btn-direction");
// API_URL dəyişəni digər yerdə təyin olunmalıdır. (Məsələn, index.html-də və ya başqa bir faylda)
// const API_URL = "https://codebyte-backend-ibyq.onrender.com"; 
// const userData = ...; // Bu dəyişənlərinizin də təyin olunduğunu güman edirəm
// const logData = ...; 
// const searchInp = ...; 
